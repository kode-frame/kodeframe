...
export function ServiceCard({ service }: ServiceCardProps) {
  return (
    <Card
      key={service.id}
      className="h-full bg-electric-teal/10 rounded-3xl border border-electric-teal/20 flex flex-col justify-between overflow-hidden"
    >
      <CardHeader>
        <Badge
          variant="outline"
        ...
        >
          ...
          <span className="text-soft-gray/90 text-sm font-medium">
            {service.badge}
          </span>
        </Badge>
