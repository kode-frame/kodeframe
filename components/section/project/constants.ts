...
export const PROJECTS: ProjectProps[] = [
  {
    ...
    description:
      "Website jasa jahit profesional dengan layanan custom tailoring dan alteration.",
    year: "2025",
  ...
  },
  {
    ...
    description:
      "Website independent record label yang fokus pada pengembangan bakat musik urban.",
    year: "2025",
