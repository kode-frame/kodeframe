                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
                  ...
                  <div className="lg:col-span-2">
                    ...
                    <p className="text-soft-gray leading-relaxed mb-6">
                      This project presented unique challenges in creating an
                      immersive user experience while maintaining performance
                      across all devices.
                    </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.techStack.map((tech, index) => (
                          <span
                            key={index}
                            className="px-3 py-2 bg-electric-teal/10 rounded-lg text-sm text-soft-gray border border-electric-teal/10"
                          >
                            {tech.label}
                          </span>
                        ))}
                      ...
                      <div className="space-y-3">
                        {project.liveUrl && (
                          ...
                          >
                            ...
                            <ExternalLink
                              size={18}
                              className="text-electric-teal group-hover:text-white"
                            />
                          </motion.a>
                        )}
                        <motion.a
                    ...
                    <div>
                      ...
                      <div
                        className={`px-4 py-3 rounded-xl bg-linear-to-r ${project.color} text-white font-semibold text-center`}
                      >
                        {project.title}
                      </div>
                    </div>
